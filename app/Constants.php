...
class Constants
{
    ...
    const EXCHANGE = 'ayirboshlash';
    const MORTGAGE_LOAN = 'ipoteka kredit';
    const INSTALLMENT = 'bo‘lib to‘lash / rasrochka';
    ...
    const UNDER_DEMOLITION = 'Under demolition'; //buzish ostida
    const FOR_HOME = 'for home';  //uyjoy uchun
    const BOX = 'box';  //quti
    const EURO_HOUSE = 'euro house';  //yervrouy
    const UNDER_LDC_AND_TOWNSHIPS = 'under LDC and townships';  //LDC va shaharchalar ostida
    const OFFICE_BUILDINGS = 'office, buildings';  //ofis bno joylari
    const WAREHOUSES_INDUSTRIAL_ZONES = 'warehouses, industrial zones';  //Omborhona,sanoat zonalari

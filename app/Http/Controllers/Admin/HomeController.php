...
public function filterProducts(Request $request)
{
    ...
    public function getPrice($currency = 'UZS')
    {
        if ($currency === 'UZS') return $this->price_uzs;
        $rate = CurrencyRate::latest()->value("rates->$currency");
        return round($this->price_uzs / $rate, 2);
    }
}

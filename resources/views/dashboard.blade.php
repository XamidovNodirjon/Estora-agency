...
<body class="font-montserrat">
    <!-- Header -->
    <header class="header-container bg-white shadow-md" style="background-color: white;">
        ...
        <div class="top-bar hidden md:flex justify-between items-center px-4 py-2 md:px-8 lg:px-16 border-b">
            <div class="social-icons flex gap-2">
                <a href="#" class="text-white hover:text-yellow-400 touch-target flex items-center justify-center">
            ...
            <div class="contact-info flex items-center gap-4 text-white text-sm">
        ...
        <div class="main-header flex justify-between items-center px-4 py-3 md:px-8 lg:px-16">
            <div class="flex items-center gap-3">
                <button id="mobile-menu-toggle" class="mobile-menu-toggle text-white hover:text-yellow-400 md:hidden touch-target flex items-center justify-center">
            ...
            <nav class="desktop-nav hidden lg:flex space-x-6">
                @guest
                <a href="#" class="nav-link text-white hover:text-yellow-600 py-2 px-1">Ijara</a>
                <a href="#" class="nav-link text-white hover:text-yellow-600 py-2 px-1">Sotib olish</a>
                <a href="#" class="nav-link text-white hover:text-yellow-600 py-2 px-1">NoBroker</a>
                <a href="#" class="nav-link text-white hover:text-yellow-600 py-2 px-1">Expats</a>
                <a href="#" class="nav-link text-white hover:text-yellow-600 py-2 px-1">Business Space</a>
                @endguest
                @auth
            ...
            <div class="header-actions flex items-center gap-2 md:gap-4">
                ...
                <div class="hidden md:flex action-item items-center gap-2 text-white hover:text-yellow-600 cursor-pointer touch-target">
                ...
                <div class="currency-selector relative">
                    <div class="action-item flex items-center gap-1 text-white hover:text-yellow-600 cursor-pointer touch-target">
                ...
                <!-- User Action -->
                @guest
                <a href="{{ route('login.index') }}" class="user-action flex items-center gap-1 text-white hover:text-yellow-600 touch-target">
                    <i class="fas fa-user-circle text-xl"></i>
                    <span class="hidden md:inline text-sm">Login</span>
                </a>
                @endguest
                @auth
                <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="user-action flex items-center gap-1 text-white hover:text-yellow-600 touch-target">
                ...
                <div class="language-selector relative">
                    <div class="language-btn flex items-center gap-1 text-white hover:text-yellow-600 cursor-pointer touch-target">

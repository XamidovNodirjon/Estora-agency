...
@section('content')
    <div class="container-fluid py-4">
        <div class="premium-wizard">
            ...
            <form id="premium-product-form" action="{{ route('store-product') }}" method="POST"
                enctype="multipart/form-data" novalidate>
                @csrf
                <div class="wizard-body">
                    <!-- Step 1: Ad Info -->
                    <div class="premium-content active" data-step-content="1">
                        <h4 class="mb-4 text-primary fw-bold"><i
                                class="fas fa-info-circle me-2"></i>{{ __('Ad Basic Information') }}</h4>
                        <div class="form-grid">
                            ...
                            <div class="form-group full-width">
                                ...
                                <select id="subcategory_select" name="subcategory_id" class="form-control-premium" required
                                    disabled>
                    ...
                    <div class="premium-content" data-step-content="2">
                        <h4 class="mb-4 text-primary fw-bold"><i
                                class="fas fa-home me-2"></i>{{ __('Property Specifications') }}</h4>
                        <div class="form-grid">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="rooms" class="form-control-premium" placeholder="e.g. 3" min="1"
                                    required>
                            </div>
                            <div class="form-group">
                                <label class="premium-label">{{ __('Floor') }}</label>
                                <input type="number" name="floor" class="form-control-premium" placeholder="e.g. 5" min="1"
                                    required>
                            </div>
                            <div class="form-group">
                                <label class="premium-label">{{ __('Total Floors') }}</label>
                                <input type="number" name="building_floor" class="form-control-premium" placeholder="e.g. 9"
                                    min="1" required>
                            </div>
                            <div class="form-group">
                                <label class="premium-label">{{ __('Area (m²)') }}</label>
                                <input type="number" name="square" class="form-control-premium" placeholder="e.g. 75"
                                    min="1" required>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="premium-content" data-step-content="3">
                        <h4 class="mb-4 text-primary fw-bold"><i
                                class="fas fa-map-marker-alt me-2"></i>{{ __('Location & Landmarks') }}</h4>
                        <div class="form-grid">
                            <div class="form-group">
                            ...
                            <div class="form-group full-width">
                                ...
                                <textarea name="landmark" class="form-control-premium" rows="2"
                                    placeholder="{{ __('What is near?') }}" required></textarea>
                            </div>
                            <div class="form-group full-width">
                                ...
                                <div class="modern-toggle-group">
                                    @foreach($metros as $m)
                                        <div class="modern-toggle-item" onclick="toggleCheckbox('metro_{{ $m->id }}')">
                                            ...
                                            <input type="checkbox" name="metro[]" id="metro_{{ $m->id }}" value="{{ $m->id }}"
                                                class="form-check-input ms-2" onclick="event.stopPropagation()">
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                                ...
                                <div class="modern-toggle-group">
                                    @foreach($university as $unver)
                                        <div class="modern-toggle-item" onclick="toggleCheckbox('unver_{{ $unver->id }}')">
                                            ...
                                            <input type="checkbox" name="university[]" id="unver_{{ $unver->id }}"
                                                value="{{ $unver->id }}" class="form-check-input ms-2"
                    ...
                    <div class="premium-content" data-step-content="4">
                        <h4 class="mb-4 text-primary fw-bold"><i class="fas fa-tag me-2"></i>{{ __('Pricing & Features') }}
                        </h4>
                        <div class="form-grid">
                            <div class="form-group full-width">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="price"
                                        class="form-control-premium border-start-0 fs-4 fw-bold text-success"
                                    ...
                                    @foreach($opts as $key => $label)
                                        <div class="modern-toggle-item">
                                            ...
                                            <div class="form-check form-switch p-0">
                                                ...
                                                <input type="checkbox" name="{{ $key }}" value="1" class="form-check-input ms-0"
                                                    id="sw_{{ $key }}">
                                            </div>
                                        </div>
                                    @endforeach
                                ...
                                <div class="modern-toggle-group">
                                    @foreach($product_features as $feature)
                                        <div class="modern-toggle-item" onclick="toggleCheckbox('feat_{{ $feature->id }}')">
                                            ...
                                            <input type="checkbox" name="features[]" id="feat_{{ $feature->id }}"
                                                value="{{ $feature->id }}" class="form-check-input ms-2"
                                                onclick="event.stopPropagation()">
                                        </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="premium-content" data-step-content="5">
                        <h4 class="mb-4 text-primary fw-bold"><i
                                class="fas fa-camera me-2"></i>{{ __('Photos & Final Description') }}</h4>
                        ...
                        <div class="form-grid mt-4">
                            <div class="form-group full-width">
                                ...
                                <input type="text" name="phone" id="phone_mask" class="form-control-premium"
                                    placeholder="+998 90 123 45 67" required>
                            </div>
                            <div class="form-group full-width">
                                <label class="premium-label">{{ __('Detailed Description') }}</label>
                                <textarea name="description" class="form-control-premium" rows="5"
                                    placeholder="{{ __('Tell more about the property...') }}" required></textarea>
                            </div>
                        </div>
                    </div>
                </div>

...
// Standard login handles redirects based on position_id/role
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:1,2,3')->group(function () {
        ...
        Route::post('lisds/bulk-assign', [\App\Http\Controllers\Admin\LisdController::class, 'bulkAssign'])->name('lisds.bulk-assign');
        ...
        Route::post('clients', [AdminClientController::class, 'store'])->name('store-client');

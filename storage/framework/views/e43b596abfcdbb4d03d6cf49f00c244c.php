    ...
    <div class="main-header flex justify-between items-center px-4 py-4 md:px-8 lg:px-16">
        ...
        <?php if(auth()->guard()->guest()): ?>
            <nav class="desktop-nav hidden md:flex space-x-6">
                <a href="#" class="nav-link text-gray-700 hover:text-yellow-600"><?php echo e(__('Ijaraga')); ?></a>
                <a href="#" class="nav-link text-gray-700 hover:text-yellow-600"><?php echo e(__('Sotib olish')); ?></a>
                <a href="#" class="nav-link text-gray-700 hover:text-yellow-600"><?php echo e(__('NoBroker')); ?></a>
                <a href="#" class="nav-link text-gray-700 hover:text-yellow-600"><?php echo e(__('Expats')); ?></a>
                <a href="#" class="nav-link text-gray-700 hover:text-yellow-600"><?php echo e(__('Business Space')); ?></a>
            </nav>
        <?php endif; ?>
        ...
        <!-- <a href="<?php echo e(route('login.index')); ?>" class="post-ad-btn flex items-center gap-2 bg-yellow-600 text-white px-4 py-2 rounded hover:bg-yellow-700">
            ...
            <div class="language-selector relative">
                <div
                    class="language-btn flex items-center gap-1 text-gray-600 hover:text-yellow-600 cursor-pointer select-none">
                    <span
                        class="flag-icon flag-icon-<?php echo e(app()->getLocale() === 'en' ? 'gb' : app()->getLocale()); ?>"></span>
                ...
                <div class="language-menu absolute right-0 mt-2 w-28 bg-white shadow-lg rounded hidden">
                    <a href="<?php echo e(route('lang.switch', 'uz')); ?>" class="language-option flex items-center gap-2 px-3 py-2 text-gray-700 hover:bg-gray-100">
                        <span class="flag-icon flag-icon-uz"></span>
                        <span>O'zbek</span>
                    </a>
                    <a href="<?php echo e(route('lang.switch', 'ru')); ?>" class="language-option flex items-center gap-2 px-3 py-2 text-gray-700 hover:bg-gray-100">
                        <span class="flag-icon flag-icon-ru"></span>
                        <span>Русский</span>
                    </a>
                    <a href="<?php echo e(route('lang.switch', 'en')); ?>" class="language-option flex items-center gap-2 px-3 py-2 text-gray-700 hover:bg-gray-100">
...
<?php /**PATH C:\Users\Asus\Desktop\Projects\UyTop\resources\views/layouts/header.blade.php ENDPATH**/ ?>
        ...
        <div class="h-100" data-simplebar>
            <div id="sidebar-menu">
                <ul id="side-menu">
                    ...
                    <li>
                        <a href="<?php echo e(route('manager')); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('manager.seen-products')); ?>">
                            <i class="mdi mdi-view-dashboard-outline"></i>
                            <span class="badge bg-success rounded-pill float-end"></span>
...
<?php /**PATH C:\Users\Asus\Desktop\Projects\UyTop\resources\views/layouts/managers_layout.blade.php ENDPATH**/ ?>
                ...
                <div class="mb-6 animate-fade-in">
                    <div class="bg-white border-l-4 rounded-xl shadow-lg p-4" style="border-color: #00A859;">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <p class="font-semibold" style="color: #00A859;"><?php echo e(session('success')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white shadow-lg rounded-2xl overflow-hidden card-hover">
                    ...
                    <div class="p-4 sm:p-6">
                        <div class="flex items-center justify-between mb-5">
                            ...
                            <?php echo e(count($features)); ?>

                        </span>
                        </div>

                        <!-- Add Form -->
                        <form action="<?php echo e(route('product.features.store')); ?>" method="POST" class="mb-5">
                            <?php echo csrf_field(); ?>
                        ...
                        <div class="overflow-x-auto rounded-xl border border-gray-200">
                            <table class="w-full text-sm">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr style="transition: background-color 0.2s;">
                                        <td class="p-2 sm:p-3 text-gray-600 font-medium"><?php echo e($key+1); ?></td>
                                        <td class="p-2 sm:p-3 text-gray-800 font-semibold"><?php echo e($feature->feature_name); ?></td>
                                        <td class="p-2 sm:p-3">
                                            <div class="table-actions">
                                                <form action="<?php echo e(route('product.features.update', $feature->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PUT'); ?>
                                                    <input type="text" name="feature_name" value="<?php echo e($feature->feature_name); ?>"
                                                ...
                                                <form action="<?php echo e(route('product.features.destroy', $feature->id)); ?>" method="POST"
                ...
                <div class="bg-white shadow-lg rounded-2xl overflow-hidden card-hover">
                    ...
                    <div class="p-4 sm:p-6">
                        <div class="flex items-center justify-between mb-5">
                            ...
                            <?php echo e(count($metros)); ?>

                        </span>
                        </div>

                        <!-- Add Form -->
                        <form action="<?php echo e(route('metro.store')); ?>" method="POST" class="mb-5">
                            <?php echo csrf_field(); ?>
                            <div class="flex gap-2">
                        ...
                        <div class="overflow-x-auto rounded-xl border border-gray-200">
                            <table class="w-full text-sm">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                <?php $__empty_1 = true; $__currentLoopData = $metros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $metro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr style="transition: background-color 0.2s;">
                                        <td class="p-2 sm:p-3 text-gray-600 font-medium"><?php echo e($key+1); ?></td>
                                        <td class="p-2 sm:p-3 text-gray-800 font-semibold"><?php echo e($metro->metro_name); ?></td>
                                        <td class="p-2 sm:p-3">
                                            <div class="table-actions">
                                                <form action="<?php echo e(route('metro.update', $metro->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PUT'); ?>
                                                    <input type="text" name="metro_name" value="<?php echo e($metro->metro_name); ?>"
                                                           class="border border-gray-300 rounded-lg px-2 py-1 text-xs edit-input focus:outline-none"
                                                ...
                                                <form action="<?php echo e(route('metro.destroy', $metro->id)); ?>" method="POST"
            ...
            <div class="bg-white shadow-lg rounded-2xl overflow-hidden card-hover">
                ...
                <div class="p-4 sm:p-6">
                    <div class="flex items-center justify-between mb-5">
                        ...
                        <?php echo e(count($universities)); ?>

                    </span>
                    </div>

                    <!-- Add Form -->
                    <form action="<?php echo e(route('university.store')); ?>" method="POST" class="mb-5">
                        <?php echo csrf_field(); ?>
                        <div class="flex gap-2">
                    ...
                    <div class="overflow-x-auto rounded-xl border border-gray-200">
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y divide-gray-100">
                            <?php $__empty_1 = true; $__currentLoopData = $universities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $university): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr style="transition: background-color 0.2s;">
                                    <td class="p-2 sm:p-3 text-gray-600 font-medium"><?php echo e($key+1); ?></td>
                                    <td class="p-2 sm:p-3 text-gray-800 font-semibold"><?php echo e($university->university_name); ?></td>
                                    <td class="p-2 sm:p-3">
                                        <div class="table-actions">
                                            <form action="<?php echo e(route('university.update', $university->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('PUT'); ?>
                                                <input type="text" name="university_name" value="<?php echo e($university->university_name); ?>"
                                                       class="border border-gray-300 rounded-lg px-2 py-1 text-xs edit-input focus:outline-none"
                                            ...
                                            <form action="<?php echo e(route('university.destroy', $university->id)); ?>" method="POST"
...
<?php echo $__env->make('layouts.admin_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Asus\Desktop\Projects\UyTop\resources\views/Admin/product_features/index.blade.php ENDPATH**/ ?>
...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE products ALTER COLUMN status DROP DEFAULT");
        DB::statement("ALTER TABLE products ALTER COLUMN status TYPE BOOLEAN USING CASE WHEN status='active' THEN true ELSE false END");
        DB::statement("ALTER TABLE products ALTER COLUMN status SET DEFAULT true");
    }
};
